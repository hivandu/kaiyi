...
var app = {
    ...
    preload: function () {
        ...
        function prestartProcess () {
            ...
            $('.loading-plain').one('touchstart', function () {
                ...
                video01.play();
                var ch = document.documentElement.clientHeight;
                $('.video01').css({minHeight: ch+1, maxHeight: ch+1, width: Math.floor(ch*0.6213592233)+1, height: 'auto'});
    ...
    startScene02: function () {
        ...
        video02.play();
        var ch = document.documentElement.clientHeight;
        $('.video02').css({minHeight: ch+1, maxHeight: ch+1, width: Math.floor(ch*0.6213592233)+1, height: 'auto'});
    ...
    startScene03: function () {
        ...
        $('.submit').on('touchstart', function () {
            ...
            video03.play();
            var ch = document.documentElement.clientHeight;
            $('.video03').css({minHeight: ch+1, maxHeight: ch+1, width: Math.floor(ch*0.6213592233)+1, height: 'auto'});
